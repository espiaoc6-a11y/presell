...
<head>
    ...
    <meta name="description" content="Central de Atendimento ao Cidadão - Realize consultas de forma rápida e segura com nossa plataforma.">
    <meta name="author" content="Governo do Brasil">
    <meta name="robots" content="index, follow">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <title>Central de Atendimento ao Cidadão</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css">
<!-- ANALYTICS (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-X0V5DYM3QX"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-X0V5DYM3QX');
</script>


<!-- Google 01 (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=AW-715234635"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'AW-715234635');
</script>


<!-- GOOGLE 02 (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=AW-11088821139"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'AW-11088821139');
</script>
...
<body>
    <div class="container">
        <h1 class="title">CONSULTAR FACIL</h1>
        <p class="subtitle">Clique no botão abaixo para acessar serviços públicos de forma rápida e segura.</p>
        <a id="chatButton" class="button" href="#">
            <i class="fas fa-comments"></i> CONSULTAR AGORA
        </a>
        <div class="links">
            <a href="politica-privacidade.html"><i class="fas fa-shield-alt"></i> Política de Privacidade</a>
            <a href="termos-uso.html"><i class="fas fa-file-alt"></i> Termos de Uso</a>
            <a href="servicos.html"><i class="fas fa-cogs"></i> Serviços</a>
        </div>
        <footer>
            &copy; 2025 Consultar Facil Brasil. Todos os direitos reservados. <a href="servicos.html">Contato</a>
        </footer>
    </div>

    <!-- Container do Quiz (substituindo o Typebot) -->
    <div id="typebotContainer">
    ...
    <!-- Script do Quiz (substituindo o Typebot) -->
    <script>
